...
edgeData <-
  gsheet2tbl(
    'https://docs.google.com/spreadsheets/d/1YzDg6Bmb-bIOkzAMMqB6oEAV2k9A-nWGNkLgGgcN7OA/pub?gid=0&single=true&output=csv'
  )

nodeData <-
  gsheet2tbl(
    'https://docs.google.com/spreadsheets/d/1YzDg6Bmb-bIOkzAMMqB6oEAV2k9A-nWGNkLgGgcN7OA/pub?gid=887688557&single=true&output=csv'
  )
